...
fn get_char_bitmap(c: char) -> [u8; 7] {
    match c {
        ...
        'J' => [
            0b00111, 0b00010, 0b00010, 0b00010, 0b10010, 0b01100, 0b00000,
        ],
        'K' => [
        ...
        'P' => [
            0b11110, 0b10001, 0b10001, 0b11110, 0b10000, 0b10000, 0b00000,
        ],
        'Q' => [
            0b01110, 0b10001, 0b10001, 0b10101, 0b10010, 0b01101, 0b00000,
        ],
        'R' => [
            0b11110, 0b10001, 0b10001, 0b11110, 0b10010, 0b10001, 0b00000,
        ],
        'S' => [
        ...
        'X' => [
            0b10001, 0b10001, 0b01010, 0b00100, 0b01010, 0b10001, 0b00000,
        ],
        'Y' => [
            0b10001, 0b10001, 0b01010, 0b00100, 0b00100, 0b00100, 0b00000,
        ],
        'Z' => [
            0b11111, 0b00001, 0b00010, 0b00100, 0b01000, 0b11111, 0b00000,
        ],
        // Letters (lowercase)
        'a' => [
        ...
        'b' => [
            0b10000, 0b10000, 0b11110, 0b10001, 0b10001, 0b11110, 0b00000,
        ],
        'c' => [
            0b00000, 0b01110, 0b10000, 0b10000, 0b10000, 0b01110, 0b00000,
        ],
        'd' => [
            0b00001, 0b00001, 0b01111, 0b10001, 0b10001, 0b01111, 0b00000,
        ],
        'e' => [
            0b00000, 0b01110, 0b10001, 0b11111, 0b10000, 0b01110, 0b00000,
        ],
        'f' => [
            0b00110, 0b01001, 0b01000, 0b11110, 0b01000, 0b01000, 0b00000,
        ],
        'g' => [
            0b00000, 0b01111, 0b10001, 0b01111, 0b00001, 0b01110, 0b00000,
        ],
        'h' => [
            0b10000, 0b10000, 0b11110, 0b10001, 0b10001, 0b10001, 0b00000,
        ],
        'i' => [
            0b00100, 0b00000, 0b01100, 0b00100, 0b00100, 0b01110, 0b00000,
        ],
        'j' => [
            0b00010, 0b00000, 0b00110, 0b00010, 0b10010, 0b01100, 0b00000,
        ],
        'k' => [
        ...
        'n' => [
            0b00000, 0b10110, 0b11001, 0b10001, 0b10001, 0b10001, 0b00000,
        ],
        'o' => [
            0b00000, 0b01110, 0b10001, 0b10001, 0b10001, 0b01110, 0b00000,
        ],
        'p' => [
            0b00000, 0b11110, 0b10001, 0b11110, 0b10000, 0b10000, 0b00000,
        ],
        'q' => [
            0b00000, 0b01111, 0b10001, 0b01111, 0b00001, 0b00001, 0b00000,
        ],
        'r' => [
            0b00000, 0b10110, 0b11001, 0b10000, 0b10000, 0b10000, 0b00000,
        ],
        's' => [
            0b00000, 0b01111, 0b10000, 0b01110, 0b00001, 0b11110, 0b00000,
        ],
        't' => [
            0b01000, 0b01000, 0b11110, 0b01000, 0b01000, 0b00110, 0b00000,
        ],
        'u' => [
            0b00000, 0b10001, 0b10001, 0b10001, 0b10001, 0b01111, 0b00000,
        ],
        'v' => [
            0b00000, 0b10001, 0b10001, 0b10001, 0b01010, 0b00100, 0b00000,
        ],
        'w' => [
            0b00000, 0b10001, 0b10001, 0b10101, 0b11011, 0b10001, 0b00000,
        ],
        'x' => [
            0b00000, 0b10001, 0b01010, 0b00100, 0b01010, 0b10001, 0b00000,
        ],
        'y' => [
            0b00000, 0b10001, 0b10001, 0b01111, 0b00001, 0b01110, 0b00000,
        ],
        'z' => [
            0b00000, 0b11111, 0b00010, 0b00100, 0b01000, 0b11111, 0b00000,
        ],
        // Digits
        '0' => [
            0b01110, 0b10011, 0b10101, 0b10101, 0b11001, 0b01110, 0b00000,
        ],
        '1' => [
        ...
        '3' => [
            0b01110, 0b10001, 0b00110, 0b00001, 0b10001, 0b01110, 0b00000,
        ],
        '4' => [
            0b00010, 0b00110, 0b01010, 0b10010, 0b11111, 0b00010, 0b00000,
        ],
        '5' => [
        ...
        '9' => [
            0b01110, 0b10001, 0b10001, 0b01111, 0b00001, 0b01110, 0b00000,
        ],
        // Punctuation
        ':' => [
