...
pub(crate) const DEFAULT_CLIENT_VERSION: &str = "1.0.9254";
...
pub(crate) const DEFAULT_CLIENT_BUILD_NUMBER: u64 = 595897;
pub(crate) const DEFAULT_NATIVE_BUILD_NUMBER: u64 = 88466;
