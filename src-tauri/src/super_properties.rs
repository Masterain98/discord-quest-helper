...
// ─────────────────────────────────────────────────────────────────────────────
pub(crate) const DEFAULT_CLIENT_VERSION: &str = "1.0.9249";
...
pub(crate) const DEFAULT_CLIENT_BUILD_NUMBER: u64 = 582977;
pub(crate) const DEFAULT_NATIVE_BUILD_NUMBER: u64 = 86777;
