...
// ─────────────────────────────────────────────────────────────────────────────
pub(crate) const DEFAULT_CLIENT_VERSION: &str = "1.0.9244";
...
pub(crate) const DEFAULT_CLIENT_BUILD_NUMBER: u64 = 574548;
pub(crate) const DEFAULT_NATIVE_BUILD_NUMBER: u64 = 85420;
