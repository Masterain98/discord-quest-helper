...
pub(crate) const DEFAULT_CLIENT_VERSION: &str = "1.0.9251";
...
pub(crate) const DEFAULT_CLIENT_BUILD_NUMBER: u64 = 589596;
pub(crate) const DEFAULT_NATIVE_BUILD_NUMBER: u64 = 87870;
