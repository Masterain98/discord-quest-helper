export default {
    ...
    settings: {
        ...
        cdp_restart_confirm_title: "CDP で Discord を再起動しますか？",
        cdp_restart_confirm_desc: "Discord は現在実行中です。続行すると現在の Discord クライアントを閉じ、CDP を有効にして再起動します。",
        cdp_restart_confirm_action: "Discord を再起動",
        ...
        cdp_shortcut_warning: "このショートカットは安定したランチャーを使用するため、Discord 更新後も有効です。",
        ...
        mode_simulate: "シミュレートモード",
        mode_heartbeat: "ハートビートモード",
