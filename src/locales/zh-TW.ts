export default {
    ...
    settings: {
        ...
        game_polling_desc: "用於遊戲/遊戲類任務：檢查任務進度的頻率。透過 Discord RPC 回報活動，僅用於輪詢狀態。",
        ...
        game_quest_mode_desc: "選擇完成遊戲/遊戲任務的方式。直接心跳模式可跳過遊戲模擬。",
        ...
        cdp_restart_confirm_title: "使用 CDP 重新啟動 Discord？",
        cdp_restart_confirm_desc: "Discord 目前正在執行。繼續會關閉目前的 Discord 客戶端，並以 CDP 模式重新啟動。",
        cdp_restart_confirm_action: "重新啟動 Discord",
        ...
        cdp_shortcut_warning: "此捷徑會指向穩定啟動器，Discord 更新後仍可使用。",
    ...
    game_sim: {
        title: "遊戲模擬",
        description: "模擬執行遊戲以完成直播/遊戲任務，無需實際執行遊戲。",
        detectables: "可偵測的遊戲",
        select_title: "選擇遊戲",
        search: "搜尋遊戲...",
        no_games: "找不到遊戲",
